        ...
        <>
            <main className="container">
                <section className="content use-rules">
                    ...
                    <ul>
                        <li>Es importante que los usuarios se registren para poder hacer uso de la dependencia.</li>
                        <br />
                        <li>Es necesario instalar la dependencia Axios.
                            <br />
                            <br />
                    ...
                    <ul>
                        <li>Para poder hacer uso de los ejemplos de componentes en React, que se incluyan en la dependencia, los
                            usuarios deberán instalarse React.
                            <br />
                            <br />
                    ...
                    <ol>
                        ...
                        <li><b>Inicialización:</b> Para poder utilizar Neskatila, es necesario que los usuarios la inicialicen.
                            <br />
                            <br />
                            Para ello, deberán importarse <code>{ initNeskatilaComoTexto }</code> a su fichero:
                            <br />
                            <br />
                            <code>import { initNeskatilaComoTexto } from 'neskatila';</code>
                            <br />
                            <br />
                            Una vez hecho, deben invocar <code>{ initNeskatilaComoTexto }</code> y pasar un objeto con las propiedades apiKey y
                            serverURL y añadiendoles la clave API y el serverURL proporcionadas al estar registrados en nuestra aplicación
                            web.
                            <br />
                            <br />
                        ...
                        <br />
                        <li><b>Importación:</b> Los usuarios pueden importarla en su archivo.
                            <br />
                            <br />
                        ...
                        <li><b>Traducción:</b> Ahora los usuarios pueden usar el método <code>translate</code> para traducir textos.
                            Este método es una función asíncrona que realiza una solicitud GET al servidor especificado en el serverURL,
                            por lo que necesitarán usar <code>await</code> o <code>.then()</code> para manejar la
                            respuesta.
                            <br />
                            <br />
                            Esta solicitud incluye como parámetros de consulta los idiomas de origen y destino y el texto a
                            traducir.
                            <br />
                            <br />
                            Por ejemplo:
                        ...
                        <li><b>Uso del Hook:</b> También pueden usar el hook <code>useNeskatila</code> para acceder al método <code>{ TranslateComoTexto }</code>.
                            <br />
                            <br />
                            Por ejemplo: Este código hace lo mismo que el anterior, pero utilizando el hook <code>useNeskatila</code>.
                            <br />
                            <br />
                            ...
                            <br />
                            <br />
                            Esto puede ser útil si están trabajando con un componente de React. 
                            <br />
                            <br />
                            En la pestaña "Uso en React" iremos
                            incorporando diferentes ejemplos de componentes en las cuales se utiliza Neskatila.
                            <br />
                            <br />
                            También serán descargados junto con la dependencia y el usuario podrá hacer uso de ellos.
                        </li>
                    </ol>
                </section>
            </main>
